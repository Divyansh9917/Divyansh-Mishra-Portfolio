    ...
    <section id="contact" className={s.section}>
      <div ref={ref} className={`reveal ${s.inner}`}>
        ...
        <div className={s.socials}>
          <a href="https://linkedin.com/in/divyansh-mishra" target="_blank" rel="noopener" className={s.socialBtn} data-hover>
          ...
          <a href="https://leetcode.com/divyansh9917" target="_blank" rel="noopener" className={s.socialBtn} data-hover>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://codechef.com/users/divyansh9917" target="_blank" rel="noopener" className={s.socialBtn} data-hover>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
